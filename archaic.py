...
def checkenemy():
    ...
    if paul == 1 or check_paul == 1:
        print("A creature emerges from the darkness, t's head blazes with fire")
        enemy = "Paul"
        return
    if check_paul != 1:
        if roomx+roomy < 4:
            ...
            enemy = "Orc"
        elif (roomx == 5 and roomy == 4) or (roomx == 4 and roomy == 5) or (roomx == 4 and roomy == 4) :
